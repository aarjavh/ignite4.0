gsap.registerPlugin(ScrollTrigger);
    ...
    // hills animation 
    scene1.to("#h1-1", { y: 3 * speed, ease: "power1.in" }, 0)
    scene1.to("#h1-2", { y: 2.6 * speed, x: -0.6 * speed, ease: "power1.in" }, 0)
    scene1.to("#h1-3", { y: 1.7 * speed, x: 1.2 * speed }, 0.03)
    scene1.to("#h1-4", { y: 3 * speed, x: 1 * speed }, 0.03)
    scene1.to("#h1-5", { y: 2.2 * speed, x: 1 * speed }, 0.03)
    ...
    sun.to("#bg_grad stop:nth-child(6)", { attr: { "stop-color": "#542A99" } }, 0)
    ...
    sun2.to("#bg_grad stop:nth-child(6)", { attr: { "stop-color": "#000000" } }, 0)
    ...
    sceneTransition.to("#h2-1", { y: -680, transformOrigin: "50% 50%" }, 0)
    sceneTransition.to("#bg_grad", {y:-680,opacity:0, attr: { cy: "-80" } }, 0.00)
    ...
    scene3.fromTo("#text2", { opacity: 0 }, { opacity: 0.7, y: -510 }, 0.3)
